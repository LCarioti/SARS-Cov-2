...
DataF=pd.concat([dfI,InfectRatio,DeathRatio],axis=1)
DataFinal=DataF.rename(columns={0:'InfectRatio',1:'DeathRatio'})
DataFinal.to_csv('EuRatioM.csv',index=False)
